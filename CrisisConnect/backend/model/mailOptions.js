let mailOptions = {
    from: 'cresisconnectora@gmail.com',  // sender address
    ...
    html: `
      ...
      <p>Thank you for signing up on CrisisConnect. 
      We are here to assist you in case of any emergency. 
      Please feel free to contact us anytime you need support.</p>
      <p>Best regards,</p>
